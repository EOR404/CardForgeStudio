...
- 版本管理：角色、世界书、项目与高级模块快照备注、快照列表、当前字段/条目差异、Regex/变量/脚本/前端/插件配置恢复，并可在导出页选择角色快照版本。
...
- 图片资源库：图片/文本/JSON/脚本资源导入、拖拽、缩略图、用途标记、项目库与本机全局库互相复制、复制到其他项目、AI 图片理解、标签、角色/世界书关联、使用记录和导出图片选择。
